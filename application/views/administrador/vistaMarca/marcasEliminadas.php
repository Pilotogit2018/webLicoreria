                    ...
                    <ul class="nav navbar-right panel_toolbox">
                      ...
                      <li class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <a class="dropdown-item" href="<?php echo base_url();?>index.php/marca/lista">lista de categorias</a>
                        ...
                        <?php
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                        <?php
                                            echo form_open_multipart('marca/habilitarbd');//manda al controlador categoria metoodo eliminarbd
                                        ?>
