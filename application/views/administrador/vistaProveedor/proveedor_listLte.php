                    ...
                    <ul class="nav navbar-right panel_toolbox">
                      ...
                      <li class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <a class="dropdown-item" href="<?php echo base_url();?>index.php/proveedor/agregarProvLte">Agregar proveedor</a>
                            <a class="dropdown-item" href="<?php echo base_url();?>index.php/proveedor/deshabilitados">deshabilitados</a>
                          </div>
                      </li>
