                    ...
                    <ul class="nav navbar-right panel_toolbox">
                      ...
                      <li class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <a class="dropdown-item" href="<?php echo base_url();?>index.php/usuarios/listasUsers">Usuarios habilitados</a>
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <?php
                        ...
                        <tr>
                            ...
                            <td>
                                    <?php
                                        echo form_open_multipart('usuarios/habilitarbd');//manda al controlador categoria metoodo eliminarbd
                                    ?>
