                                    ...
                                    ?>
                                        <!--<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">-->
                                            ...
                                            <div class="item form-group">
                                                <input type="hidden" class="form-control" name="idcategoria" value="<?php echo $row->idCategoria;?>"><!--se recupera los datos para editar NECESARIO--> 
                                            ...
                                            <div class="item form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 ">
                                                    <input type="text" id="last-name"  required="required" class="form-control" name="DESCRIPCION" placeholder="ingrese descripción" value="<?php echo $row->descripcion;?>">
                                                </div>
                                            </div>
