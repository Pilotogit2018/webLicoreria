								...
								<div class="x_content">
									...
									<!--<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">-->
										...
										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="nombre">Proveedor: <span class="required">*</span>
											</label>
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="last-name"  required="required" class="form-control" name="DIRECCION" placeholder="ingrese dirección">
											</div>
										</div>
                                        <div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="number" id="last-name"  required="required" class="form-control" name="CELULAR" placeholder="ingrese teléfono">
											</div>
										</div>
										...
										<div class="item form-group">
											<div class="col-md-6 col-sm-6 offset-md-3">
												...
												<button type="submit" class="btn btn-outline-success"><b>agregar proveedor</b></button>
											</div>
										</div>
