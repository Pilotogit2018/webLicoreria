                                    ...
                                    ?> 
                                        <!--<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">-->
                                            ...
                                            <div class="item form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 ">
                                                    <input type="text" id="last-name"  required="required" class="form-control" name="DIRECCION" placeholder="ingrese descripción" value="<?php echo $row->direccion;?>">
                                                </div>
                                            </div>
                                            <div class="item form-group">
                                            ...
                                            <div class="item form-group">
                                                <div class="col-md-6 col-sm-6 offset-md-3">
                                                    ...
                                                    <button type="submit" class="btn btn-outline-success"><b>Modificar Proveedor</b></button>
                                                </div>
                                            </div>
